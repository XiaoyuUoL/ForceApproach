A repository [reference] will contain the following data:

i. Table of CSD ID and $\lambda_force$ for 4476 molecules in layer (i). (i.csv)
ii. Table of CSD ID with $\lambda_force$ and $\lambda_4p$ for 282 molecules computed in layer (ii). (ii.csv)
